    ...
    <div style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", minHeight: '100vh', background: '#FAFAFA', display: 'flex', flexDirection: 'column' }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        .auth-input { width: 100%; border: 2px solid #E0E0E0; border-radius: 8px; padding: 11px 14px; font-family: var(--font-montserrat), 'Montserrat', sans-serif; font-size: 14px; font-weight: 500; outline: none; color: #111; background: #fff; transition: border-color 0.15s; }
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.875rem 2.5rem', background: '#fff', borderBottom: '2.5px solid #111' }}>
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          ...
          <span style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", fontSize: '1rem', fontWeight: 900, color: '#111', letterSpacing: '-0.01em' }}>
        ...
        <div style={{ background: '#fff', border: '2px solid #111', borderRadius: 12, padding: '2.5rem 2rem', width: '100%', maxWidth: 460, boxShadow: '4px 4px 0 #111' }}>
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" disabled={loading} style={{ width: '100%', background: loading ? '#555' : '#111', color: '#F5C400', border: '2px solid #111', borderRadius: 8, padding: 13, fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", fontSize: 14, fontWeight: 800, cursor: loading ? 'not-allowed' : 'pointer', boxShadow: '3px 3px 0 #E8151B', letterSpacing: '0.02em' }}>
