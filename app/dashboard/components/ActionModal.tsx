...
export default function ActionModal({ isOpen, onClose, onSave, action, initialDateTime }: ActionModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontFamily: 'var(--font-montserrat), sans-serif', fontSize: 16, fontWeight: 700, marginBottom: 20, color: '#111' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 24 }}>
          <button
            ...
            style={{
              ...
              fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600, fontSize: 13,
            }}
          >
            Annuler
          </button>
