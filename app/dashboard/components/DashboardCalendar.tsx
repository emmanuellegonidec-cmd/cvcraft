...
const navBtnStyle: React.CSSProperties = {
  ...
  fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", padding: 0,
};
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: 'pointer',
        fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", overflow: 'hidden',
    ...
    <div style={{ marginBottom: '1.25rem', background: '#fff', border: '2px solid #111', borderRadius: 12, overflow: 'hidden', boxShadow: '3px 3px 0 #111' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          <span style={{ fontSize: 16, fontWeight: 900, color: '#111', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", textTransform: 'uppercase', letterSpacing: '.06em' }}>
            📅 Calendrier
          </span>
        </div>
        <button onClick={() => setVisibleState(v => !v)} style={{
          fontSize: 11, fontWeight: 800, fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif",
