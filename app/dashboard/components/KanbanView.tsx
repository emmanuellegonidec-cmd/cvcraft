...
const SOURCE_MAP: Record<string, { bg: string; color: string; label: string }> = {
  ...
  'welcome to the jungle': { bg: '#1DBE6E', color: '#fff',    label: 'Welcome to the Jungle' },
  'welcometothejungle':    { bg: '#1DBE6E', color: '#fff',    label: 'Welcome to the Jungle' },
  'wttj':                  { bg: '#1DBE6E', color: '#fff',    label: 'Welcome to the Jungle' },
  'apec':                  { bg: '#E8151B', color: '#fff',    label: 'APEC' },
  'france travail':        { bg: '#005F9E', color: '#fff',    label: 'France Travail' },
  'francetravail':         { bg: '#005F9E', color: '#fff',    label: 'France Travail' },
