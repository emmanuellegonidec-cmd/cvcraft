          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {visibleOptions.map(opt => (
              <button key={opt.mode}
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 14, background: '#fff', border: '2px solid #111', borderRadius: 10, padding: '1rem 1.25rem', cursor: 'pointer', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", textAlign: 'left', boxShadow: '2px 2px 0 #111', width: '100%' }}
        ...
        {addJobMode === 'url' && !editingJobId && isAdmin && (
          <div>
            <button onClick={() => { setAddJobMode(null); setImportError(false); setImportUrl(''); }}
              style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: '#888', fontWeight: 700, marginBottom: 12, fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>← Retour</button>
