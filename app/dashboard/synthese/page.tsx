    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media print {
          @page { margin: 1.5cm; }
          * { font-family: var(--font-montserrat), Arial, sans-serif !important; }
      ...
      <div className="synthese-page">
        ...
        <aside className="synthese-sidebar no-print">
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '14px 10px 8px', display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            {['Tableau de bord','Candidatures','Contacts','Entretiens','Événements','Statistiques'].map(label => (
              <button key={label} onClick={() => router.push('/dashboard')}
                style={{ display: 'flex', alignItems: 'center', padding: '9px 12px', border: 'none', borderLeft: '3px solid transparent', borderRadius: 0, background: 'transparent', color: '#888', fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 500, fontSize: 14, cursor: 'pointer', textAlign: 'left', width: '100%', transition: 'all 0.12s' }}
            ...
            <button style={{ display: 'flex', alignItems: 'center', padding: '9px 12px', border: 'none', borderLeft: '3px solid #E8151B', borderRadius: 0, background: '#1c1c1c', color: '#fff', fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 700, fontSize: 14, cursor: 'pointer', textAlign: 'left', width: '100%' }}>
              Synthèse
            </button>
          ...
          <div style={{ borderTop: '1px solid #1e1e1e', padding: '10px 10px 8px', flexShrink: 0 }}>
            <button onClick={() => router.push('/dashboard/profile')}
              style={{ display: 'flex', alignItems: 'center', gap: 10, width: '100%', padding: '9px 12px', border: '1px solid #242424', borderRadius: 8, background: 'transparent', cursor: 'pointer', fontFamily: 'var(--font-montserrat), sans-serif', transition: 'all 0.12s' }}
            ...
            <button onClick={() => router.push('/')}
              style={{ display: 'flex', alignItems: 'center', gap: 8, width: '100%', padding: '7px 12px', marginTop: 2, border: 'none', borderRadius: 6, background: 'transparent', color: '#444', fontFamily: 'var(--font-montserrat), sans-serif', fontWeight: 600, fontSize: 12, cursor: 'pointer', transition: 'color 0.12s' }}
        ...
        <div className="synthese-content">
          ...
          <div className="screen-title no-print" style={{ marginBottom: 28 }}>
            <h1 style={{ fontSize: 28, fontWeight: 900, color: '#111', margin: 0, fontFamily: 'var(--font-montserrat), sans-serif' }}>
          ...
          <div className="print-title">
            <h1 style={{ fontSize: 22, fontWeight: 900, color: '#111', margin: '0 0 4px 0', fontFamily: 'var(--font-montserrat), sans-serif' }}>Bilan d'activité</h1>
            <p style={{ fontSize: 13, color: '#555', margin: 0, fontFamily: 'var(--font-montserrat), sans-serif' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 12, marginBottom: 24 }}>
            {[
              ...
              <div key={s.label} className="stat-card">
                <div style={{ fontSize: 28, fontWeight: 900, color: '#111', fontFamily: 'var(--font-montserrat), sans-serif' }}>{s.value}</div>
                <div style={{ fontSize: 11, color: '#888', marginTop: 2, fontWeight: 500, fontFamily: 'var(--font-montserrat), sans-serif' }}>{s.label}</div>
              </div>
            ))}
          </div>
                    ...
                    return (
                      <tr key={job.id}>
                        ...
                        <td>
                          ...
                          {stepInfo.step !== null && (
                            <div style={{ fontSize: 10, color: '#888', marginTop: 2, fontFamily: 'var(--font-montserrat), sans-serif' }}>
