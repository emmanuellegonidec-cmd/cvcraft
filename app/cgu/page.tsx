...
- Respecter les droits de propriété intellectuelle de Jean find my Job`
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center' }}>
          <Link href="/confidentialite" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", fontSize: 13, color: '#E8151B', fontWeight: 700, textDecoration: 'underline' }}>Consulter la politique de confidentialité →</Link>
        </div>
      </main>
    </div>
  )
