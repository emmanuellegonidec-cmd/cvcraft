      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        {related.length > 0 && (
          <div style={{ maxWidth: 860, margin: '4rem auto 0' }}>
            <h4 style={{ fontSize: 11, fontWeight: 800, color: '#888', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 20, borderBottom: '2px solid #111', paddingBottom: 8, fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
