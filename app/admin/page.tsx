...
export default function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-black mb-2" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", color: '#111' }}>
        Tableau de bord
      </h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-10">
        {statCards.map((card) => (
          <div key={card.label} className="bg-white p-6 rounded" style={{ border: '2px solid #111', boxShadow: '4px 4px 0px #111' }}>
            ...
            <div className="text-4xl font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", color: '#111' }}>{card.value}</div>
      ...
      <div className="bg-white rounded p-6" style={{ border: '2px solid #111', boxShadow: '4px 4px 0px #111' }}>
        <h2 className="text-lg font-black mb-4" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>👤 Derniers inscrits</h2>
