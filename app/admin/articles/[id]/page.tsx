      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span
          ...
          style={{
            ...
            backgroundColor: form.published ? '#F5C400' : '#f3f4f6',
            color: form.published ? '#111' : '#888',
            border: form.published ? '1px solid #111' : '1px solid #ddd',
          }}
        >
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        {!showDeleteConfirm ? (
          <button
            ...
            className="px-4 py-3 font-bold text-sm rounded"
            style={{
              fontFamily: 'Montserrat, sans-serif',
