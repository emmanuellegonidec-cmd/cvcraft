  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-black" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", color: '#111' }}>
          ✍️ Éditer l&apos;article
        </h1>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="px-3 py-1 rounded text-xs font-black" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: form.published ? '#F5C400' : '#f3f4f6', color: form.published ? '#111' : '#888', border: form.published ? '1px solid #111' : '1px solid #ddd' }}>
      ...
      <div className="bg-white rounded p-6 space-y-5 mb-6" style={{ border: '2px solid #111', boxShadow: '4px 4px 0px #111' }}>
        ...
        {/* Titre */}
        <div>
          <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Titre *</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Slug (URL)</label>
          ...
          <div>
            <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Catégorie</label>
        ...
        {/* Extrait */}
        <div>
          <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Extrait</label>
        ...
        {/* Image de couverture */}
        <div>
          <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
          ...
          <div className="flex items-center gap-3 mb-3">
            <label
              ...
              style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: uploadingCover ? '#f3f4f6' : '#111', color: uploadingCover ? '#888' : '#F5C400', border: '2px solid #111', boxShadow: uploadingCover ? 'none' : '3px 3px 0 #E8151B' }}
            >
        ...
        {/* Éditeur */}
        <div>
          <label className="block text-sm font-black mb-2" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-3">
          <button onClick={() => handleSave()} disabled={saving || !tokenReady} className="px-6 py-3 font-black text-sm rounded" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: '#fff', color: '#111', border: '2px solid #111', boxShadow: '3px 3px 0px #111', opacity: (saving || !tokenReady) ? 0.6 : 1 }}>
            {saving ? 'Sauvegarde...' : '💾 Sauvegarder'}
          </button>
          {form.published ? (
            <button onClick={() => handleSave(false)} disabled={saving} className="px-6 py-3 font-black text-sm rounded" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: '#f3f4f6', color: '#555', border: '2px solid #ddd', opacity: saving ? 0.6 : 1 }}>
              Dépublier
            </button>
          ) : (
            <button onClick={() => handleSave(true)} disabled={saving || !tokenReady} className="px-6 py-3 font-black text-sm rounded" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: '#F5C400', color: '#111', border: '2px solid #111', boxShadow: '3px 3px 0px #111', opacity: (saving || !tokenReady) ? 0.6 : 1 }}>
              🚀 Publier
            </button>
          )}
        </div>
