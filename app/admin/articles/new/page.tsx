  ...
  return (
    <div className="max-w-5xl">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-black" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", color: '#111' }}>✍️ Nouvel article</h1>
      ...
      <div className="bg-white rounded p-6 space-y-5 mb-6" style={{ border: '2px solid #111', boxShadow: '4px 4px 0px #111' }}>
        ...
        {/* Extrait */}
        <div>
          <label className="block text-sm font-black mb-1" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Extrait (affiché sur la landing page)</label>
        ...
        {/* Règles images */}
        <div style={{ backgroundColor: '#fffbe6', border: '2px solid #F5C400', borderRadius: 8, padding: '10px 14px', marginBottom: 12, fontSize: 12, fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-3">
            <label className="px-4 py-2 rounded text-sm font-black cursor-pointer" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: uploadingCover ? '#f3f4f6' : '#111', color: uploadingCover ? '#888' : '#F5C400', border: '2px solid #111', boxShadow: uploadingCover ? 'none' : '3px 3px 0 #E8151B' }}>
        ...
        {/* Éditeur */}
        <div>
          <label className="block text-sm font-black mb-2" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Contenu de l&apos;article</label>
          <RichEditor
      ...
      <div className="flex gap-3">
        <button onClick={() => handleSave(false)} disabled={saving || !tokenReady} className="px-6 py-3 font-black text-sm rounded" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: '#fff', color: '#111', border: '2px solid #111', boxShadow: '3px 3px 0px #111', opacity: (saving || !tokenReady) ? 0.6 : 1 }}>
