  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-white rounded p-6 space-y-5 mb-6" style={{ border: '2px solid #111', boxShadow: '4px 4px 0px #111' }}>
        ...
        {/* Slug + Catégorie sur la même ligne */}
        ...
        <div>
          ...
          {form.cover_image_url && (
            <img src={form.cover_image_url} alt="Aperçu" className="mt-2 rounded" style={{ maxHeight: 200, objectFit: 'cover', border: '2px solid #111' }} />
          )}
        </div>
      </div>
