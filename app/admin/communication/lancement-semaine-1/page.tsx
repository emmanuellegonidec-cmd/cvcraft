  ...
  return (
    <div className="-m-8">
      <style jsx>{`
        ...
        .is-exporting .stamp { padding: 11px 16px 3px; line-height: 1; }
        .is-exporting .cta { padding: 14px 22px 7px; line-height: 1; }
        ...
        .sl-end .cta { display: inline-block; background: #F5C400; color: #111; padding: 10px 22px; border: 2px solid #111; border-radius: 8px; font-size: 17px; font-weight: 800; line-height: 1.4; box-shadow: 3px 3px 0 #111; }
