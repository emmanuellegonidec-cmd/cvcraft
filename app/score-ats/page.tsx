...
function NumBadge({ num, label }: { num: string; label: string }) {
  return (
    <div className="mb-6 inline-flex items-center gap-3 border-2 border-[#111] bg-[#F5C400] px-4 py-2 shadow-[3px_3px_0_#111]">
      <span className="font-[family-name:var(--font-montserrat)] text-2xl font-black leading-none text-[#111]">
        {num}
      </span>
      <span className="font-[family-name:var(--font-montserrat)] text-sm font-black tracking-widest text-[#111]">
        {label}
      </span>
    </div>
  )
...
export default function ScoreAtsPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-[#111] font-[family-name:var(--font-montserrat)]">
        {/* HERO */}
        <section className="border-b-2 border-[#111] bg-white">
          <div className="mx-auto max-w-5xl px-6 py-20 md:py-28">
            <h1 className="font-[family-name:var(--font-montserrat)] text-4xl font-black leading-tight md:text-6xl">
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
              {stats.map((s) => (
                <div key={s.main} className="text-center">
                  <div className="font-[family-name:var(--font-montserrat)] text-3xl font-black leading-none text-[#F5C400] md:text-4xl">
                    {s.main}
                  </div>
        ...
        <section id="le-probleme" className="border-b-2 border-[#111] bg-white">
          <div className="mx-auto max-w-5xl px-6 py-20">
            ...
            <h2 className="font-[family-name:var(--font-montserrat)] text-3xl font-black md:text-4xl">
            ...
            <div className="mt-8 grid gap-8 md:grid-cols-2">
              ...
              <div className="border-2 border-[#111] bg-white p-6 shadow-[3px_3px_0_#111]">
                <p className="font-[family-name:var(--font-montserrat)] text-xl font-black">Notre approche</p>
          ...
          <div className="mx-auto max-w-5xl px-6 py-20">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {analyseCards.map((item) => (
                ...
                >
                  <h3 className="font-[family-name:var(--font-montserrat)] text-lg font-black uppercase">
                    {item.titre}
                  </h3>
        ...
        <section className="border-b-2 border-[#111] bg-[#111] text-white">
          <div className="mx-auto max-w-5xl px-6 py-20">
            ...
            <h2 className="font-[family-name:var(--font-montserrat)] text-3xl font-black text-[#F5C400] md:text-4xl">
            ...
            <div className="mt-12">
                ...
                <div className="flex flex-col items-start gap-6 md:flex-row md:items-center">
                  <div className="relative h-24 w-24 shrink-0">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="font-[family-name:var(--font-montserrat)] text-3xl font-black text-[#1A7A4A]">
                        87
                      </span>
                  ...
                  <div className="flex-1">
                    <div className="font-[family-name:var(--font-montserrat)] text-xs font-black tracking-wider text-[#F5C400]">
                      SCORE ATS
                    </div>
                    <div className="mt-1 font-[family-name:var(--font-montserrat)] text-xl font-black text-white md:text-2xl">
                      Excellent niveau de compatibilité
                    </div>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="rounded-full bg-[#F5C400] px-3 py-1 font-[family-name:var(--font-montserrat)] text-xs font-black text-[#111]">
                        1 majeure
                      </span>
                      <span className="rounded-full bg-[#444] px-3 py-1 font-[family-name:var(--font-montserrat)] text-xs text-gray-200">
                        3 mineures
                      </span>
                    </div>
                  </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-3 md:grid-cols-3">
                {dimensions.map((d) => (
                  ...
                  >
                    <div className="font-[family-name:var(--font-montserrat)] text-xs font-black tracking-wider text-gray-600">
                      {d.name}
                    </div>
                    <div
                      className="mt-1 font-[family-name:var(--font-montserrat)] text-2xl font-black"
                      style={{ color: d.color }}
                    >
                      {d.score}
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2">
              ...
              <div>
                <div className="grid grid-cols-1 gap-3 rounded-lg bg-white p-4 sm:grid-cols-2">
                  <div className="rounded-md border border-[#1A7A4A] bg-[#E6F4EA] p-4">
                    <div className="font-[family-name:var(--font-montserrat)] text-xs font-black tracking-wider text-[#1A7A4A]">
                      POINTS FORTS
                    </div>
                  ...
                  <div className="rounded-md border border-[#E8151B] bg-[#FCE6E7] p-4">
                    <div className="font-[family-name:var(--font-montserrat)] text-xs font-black tracking-wider text-[#E8151B]">
                      POINTS FAIBLES
                    </div>
              ...
              <div>
                <div className="rounded-lg bg-white p-5">
                  <div className="font-[family-name:var(--font-montserrat)] text-xs font-black tracking-wider text-gray-700">
                    RECOMMANDATIONS
                  </div>
                  <ul className="mt-4 space-y-3">
                    {recommandations.map((r, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <span
                          className={`shrink-0 px-2 py-0.5 font-[family-name:var(--font-montserrat)] text-xs font-black ${
                            r.severity === "MAJEURE"
                              ? "bg-[#F5C400] text-[#111]"
       ...
       {/* 8 POINTS À VÉRIFIER */}
          ...
          <div className="mx-auto max-w-5xl px-6 py-20">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {points.map((p) => (
                ...
                >
                  <div className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#111] bg-[#F5C400] font-[family-name:var(--font-montserrat)] text-2xl font-black text-[#111]">
                    {p.num}
                  </div>
                  <h3 className="mt-4 font-[family-name:var(--font-montserrat)] text-base font-black text-[#111]">
                    {p.titre}
                  </h3>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {pilotage.map((f) => (
                ...
                >
                  ...
                  <h3 className="mt-3 font-[family-name:var(--font-montserrat)] text-lg font-black text-[#F5C400]">
                    {f.titre}
                  </h3>
          ...
          <div className="mx-auto max-w-5xl px-6 py-20">
            ...
            <div className="mt-10 space-y-4">
              {faqData.map((item, idx) => (
                ...
                >
                  <summary className="flex cursor-pointer items-center justify-between font-[family-name:var(--font-montserrat)] text-lg font-black">
                    {item.question}
        ...
        <section className="bg-[#111] text-white">
          <div className="mx-auto max-w-5xl px-6 py-20 text-center">
            <h2 className="font-[family-name:var(--font-montserrat)] text-3xl font-black text-[#F5C400] md:text-5xl">
