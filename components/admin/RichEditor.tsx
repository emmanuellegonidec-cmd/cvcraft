...
const ToolbarButton = ({ onClick, active, title, children }: { onClick: () => void; active?: boolean; title: string; children: React.ReactNode }) => (
  <button type="button" onClick={onClick} title={title} className="px-2 py-1 rounded text-sm font-bold transition-all" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: active ? '#F5C400' : 'transparent', color: active ? '#111' : '#444', border: active ? '1px solid #111' : '1px solid transparent' }}>
    {children}
  </button>
)
  ...
  return (
    <div style={{ border: '2px solid #111', borderRadius: 8, overflow: 'hidden' }}>
      ...
      <div className="flex flex-wrap items-center gap-1 p-2" style={{ backgroundColor: '#f9f9f9', borderBottom: '2px solid #111' }}>
        ...
        <button type="button" onClick={() => fileInputRef.current?.click()} disabled={uploading} title="Uploader une image (nom SEO généré automatiquement)" className="px-2 py-1 rounded text-sm font-bold" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif", backgroundColor: 'transparent', color: '#444', border: '1px solid transparent' }}>
      ...
      {showAltPopup && (
        <div ref={altPopupRef} className="px-4 py-3 flex items-center gap-3 flex-wrap" style={{ backgroundColor: '#f0fdf4', borderBottom: '2px solid #16a34a' }}>
          <span className="text-xs font-black" style={{ color: '#16a34a', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>✅ Image uploadée — Texte alternatif SEO :</span>
          <input
            ref={altInputRef}
            type="text"
            value={pendingAlt}
          ...
          />
          <button type="button" onClick={insertImageWithAlt} className="px-3 py-1 rounded text-xs font-black" style={{ backgroundColor: '#16a34a', color: '#fff', border: '1px solid #16a34a', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>
            Insérer
          </button>
      ...
      {showLinkInput && (
        <div className="flex items-center gap-2 px-3 py-2" style={{ backgroundColor: '#fffbe6', borderBottom: '1px solid #F5C400' }}>
          <span className="text-xs font-bold" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>URL :</span>
          ...
          <button type="button" onClick={addLink} className="px-3 py-1 rounded text-xs font-black" style={{ backgroundColor: '#F5C400', color: '#111', border: '1px solid #111', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Insérer</button>
      ...
      {showImageInput && (
        <div className="flex items-center gap-2 px-3 py-2 flex-wrap" style={{ backgroundColor: '#fffbe6', borderBottom: '1px solid #F5C400' }}>
          <span className="text-xs font-bold" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Image :</span>
          ...
          <button type="button" onClick={addImageFromUrl} className="px-3 py-1 rounded text-xs font-black" style={{ backgroundColor: '#F5C400', color: '#111', border: '1px solid #111', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Insérer</button>
      ...
      {showCtaInput && (
        <div className="flex items-center gap-2 px-3 py-2 flex-wrap" style={{ backgroundColor: '#fffbe6', borderBottom: '1px solid #F5C400' }}>
          <span className="text-xs font-bold" style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>CTA :</span>
          ...
          <button type="button" onClick={addCta} className="px-3 py-1 rounded text-xs font-black" style={{ backgroundColor: '#F5C400', color: '#111', border: '1px solid #111', fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}>Insérer</button>
