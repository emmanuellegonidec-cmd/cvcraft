    ...
    <>
      {!showCustomize && (
        <div
          ...
          style={{ fontFamily: 'var(--font-montserrat), sans-serif', boxShadow: '0 -8px 0 0 rgba(0,0,0,1)' }}
        >
      ...
      {showCustomize && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div
            ...
            style={{ fontFamily: 'var(--font-montserrat), sans-serif', boxShadow: '8px 8px 0 0 rgba(0,0,0,1)' }}
          >
